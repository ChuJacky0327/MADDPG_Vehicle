...
class single_env():
    ...
    def step(self, obs, actions, nextstep_count):
        ...
        for i in range (self.n_agents):
            ...
            all_data_rate.append(data_rate)
            all_Transmission_delay.append(Transmission_delay)
            all_power_consumption.append(power_consumption)
            #print(reward)
            #print('--------------')
        
        #print(rewards)
        #print('----------')
        return observation_, rewards, terminate, {}, all_data_rate,all_Transmission_delay, all_power_consumption
